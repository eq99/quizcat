...
// life cicles
onMounted(async () => {
  iQuestion.value = getIQuestionById(route.params.interId as string);
});

onBeforeRouteUpdate(async (to, from) => {
  // set new question
  if (to.params.interId !== from.params.interId) {
    iQuestion.value = getIQuestionById(to.params.interId as string);
